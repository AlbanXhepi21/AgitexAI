export const portfolioProjects = [
  {
    ...
    metric: { value: "60%", label: "less time on support lookups" },
    tags: ["LangChain", "OpenAI", "RAG", "FastAPI", "pgvector", "React"],
  },
  {
    id: "2",
    cardLabel: "MLOps · 12 weeks",
  ...
  {
    id: "3",
    cardLabel: "Data Platform · 10 weeks",
    ...
    metric: { value: "80%", label: "less manual ETL work" },
    tags: ["Airflow", "dbt", "BigQuery", "Terraform", "Python"],
  },
  {
    id: "4",
    cardLabel: "AI Agent · 6 weeks",
    ...
    metric: { value: "70%", label: "tickets with AI-first drafts" },
    tags: ["PydanticAI", "OpenAI", "FastAPI", "React", "Zendesk"],
  },
  {
    id: "5",
    cardLabel: "Document AI · 6 weeks",
